...
public class TaiKhoan {
    ...
    public TaiKhoan(String chuTk, String matKhau, long soDu, String soTK) {
        this.chuTk = chuTk;
    ...
    public TaiKhoan(String chuTk, String soTK, String matKhau) {
        this.chuTk = chuTk;
        this.matKhau = matKhau;
        this.soDu = 0;
        this.soTK = soTK;
...
//    public void nhanTien(TaiKhoan_Vo_Nguyen_Dai_Hieu tkNhan, long soTien) {
//        tkNhan.setSoTK(tkNhan.getSoTK()+soTien);
//    }

    //    phương thức chuyển tiền
    public void chuyenTien(long soTien) {
        if (soTien > this.soDu) {
            System.out.println("số dư không đủ để thực hiện giao dịch.");
        } else {
            this.soDu -= soTien;

            System.out.println("bạn vừa chuyển " + soTien );
            System.out.println("số dư hiện tại của bạn là " + this.soDu);
        }
    }
//    phương thức nhận tiền
